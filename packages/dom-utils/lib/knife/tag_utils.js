...
/**
 * @typedef {import('../../../html-parser/lib/index').Node} Node
 * @typedef {import('../../../html-parser/lib/index').CharValue} CharValue
 * @typedef {import('../../../html-parser/lib/index').NodeAttribute} NodeAttribute
 */
