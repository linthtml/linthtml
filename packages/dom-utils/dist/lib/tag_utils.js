...
/**
 * @typedef {import('../../../parser/lib/index').Node} Node
 * @typedef {import('../../../parser/lib/index').CharValue} CharValue
 * @typedef {import('../../../parser/lib/index').NodeAttribute} NodeAttribute
 */
/**
 * @param {Node} node
 * @returns {boolean}
