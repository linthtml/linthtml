...
describe("None regression", () => {
  it("LintHTML should report the same errors with the new config and the old config", async () => {
    ...
    expect(legacy_linter.length).toBe(new_linter.length);
