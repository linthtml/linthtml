...
describe('legacy linter | "indent-style" + "indent-width"', () => {
  ...
  describe('"tabs" style', () => {
    it(
      "Should not report any error when the correct number of tabs is used",
      async () => {
    ...
    it(
      "Should not report any error when the correct number of tabs is used (complex)",
      async () => {
        const linter = createLinter({
          "indent-style": "tabs",
          "indent-width": 1
    ...
    it(
      "Should report an error when an incorrect number of tabs is used (to many)",
      async () => {
        const linter = createLinter({
          "indent-style": "tabs",
          "indent-width": 1
    ...
    it(
      "Should report an error when an incorrect number of tabs is used (not enought)",
      async () => {
        const linter = createLinter({
          "indent-style": "tabs",
          "indent-width": 2
  ...
  describe('"spaces" style', () => {
    it(
      "Should not report any error when the correct number of spaces is used",
      async () => {
        const linter = createLinter({
          "indent-style": "spaces",
          "indent-width": 2
    ...
    it(
      "Should report an error when an incorrect number of spaces is used (to many)",
      async () => {
        const linter = createLinter({
          "indent-style": "spaces",
          "indent-width": 1
    ...
    it(
      "Should report an error when an incorrect number of spaces is used (not enought)",
      async () => {
        const linter = createLinter({
          "indent-style": "spaces",
          "indent-width": 2
  ...
  it(
    "Should report an error when closing tag does not have the indent as the opening tag",
    async () => {
      const linter = createLinter({
        "indent-style": "spaces",
        "indent-width": 2
