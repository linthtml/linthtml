...
describe("legacy linter | input-radio-req-name", () => {
  ...
  it(
    "Should not report any error for radio input with a name",
    async () => {
  ...
  it(
    "Should report an error for radio input without a name",
    async () => {
      const linter = createLinter({ "input-radio-req-name": true });
  ...
  it(
    "Should not report any error if input is not a radio input",
    async () => {
      const linter = createLinter({ "input-radio-req-name": true });
