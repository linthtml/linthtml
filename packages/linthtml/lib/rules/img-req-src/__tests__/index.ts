...
describe("legacy linter | img-req-src", () => {
  ...
  it(
    "Should not report any error for <img> with an src value",
    async () => {
  ...
  it(
    "Should report an error for <img> without src alt value",
    async () => {
      const linter = createLinter({ "img-req-src": true });
      const html = "<img>";
  ...
  it(
    "Should report an error for <img> with an empty src value",
    async () => {
      const linter = createLinter({ "img-req-src": true });
      const html = '<img src="">';
