...
describe("legacy linter | link-min-length-4", () => {
  ...
  it("Report an error for links with text content with less than 4 chars", async () => {
    const linter = createLinter({ "link-min-length-4": true });
  ...
  it("Report an error for links with an aria-label's content with less than 4 chars", async () => {
    const linter = createLinter({ "link-min-length-4": true });
  ...
  it("Report nothing for links with an aria-label's content with more than 4 chars", async () => {
    const linter = createLinter({ "link-min-length-4": true });
  ...
  it("Report nothing for links with an aria-label's content with 4 chars", async () => {
    const linter = createLinter({ "link-min-length-4": true });
