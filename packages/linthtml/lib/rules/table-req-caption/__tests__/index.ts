...
describe("legacy linter | table-req-caption", () => {
  ...
  it(
    'Should report an error when "<table>" does not have a "<caption>"',
    async () => {
  ...
  it(
    'Should report an error when "<caption>" is not a child of "<table>"',
    async () => {
      const linter = createLinter({ "table-req-caption": true });
  ...
  it(
    'Should report an error when "<caption>" is a sibling of "<table>"',
    async () => {
      const linter = createLinter({ "table-req-caption": true });
  ...
  it(
    'Should report as many error as "<table>" without "<caption>"',
    async () => {
      const linter = createLinter({ "table-req-caption": true });
  ...
  it(
    'Should not report any error for "<table>" with "<caption>"',
    async () => {
      const linter = createLinter({ "table-req-caption": true });
