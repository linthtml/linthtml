...
describe("legacy linter | link-rel-noopener", () => {
  ...
  it('Should not report any error when "target" does not equal "_blank"', async () => {
  ...
  it('Should report an error when "target" equal "_blank" and "rel" attribute is undefined', async () => {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should report an error when "target" equal "_blank" and "rel" attribute is not equal to "noopener" or "noreferrer"', async () => {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should report an error when "target" equal "_blank" and "rel" attribute equal "noopener"', async () => {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should report an error when "target" equal "_blank" and "rel" attribute equal "noreferrer"', async () => {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should report an error when "target" equal "_blank" and "rel" attribute equal "noreferrer" and "noopener"', async () => {
    const linter = createLinter({ "link-req-noopener": true });
