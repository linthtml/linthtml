...
describe("legacy linter | attr-quote-style", () => {
  ...
  it(
    "Should report an error when invalid quote style is used (single quoted attr in double mode)",
    async () => {
  ...
  it(
    "Should report an error when invalid quote style is used (double quoted attr in single mode)",
    async () => {
  ...
  it(
    "Should throw an error when an invalid config is provided (invalid string)",
    () => {
  ...
  it(
    "Should throw an error when an invalid config is provided (invalid type)",
    () => {
