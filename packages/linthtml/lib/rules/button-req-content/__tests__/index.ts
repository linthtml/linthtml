...
describe("legacy linter | button-req-content", () => {
  ...
  it(
    "Should report an error when button has only whitespaces has content",
    async () => {
      const linter = createLinter({ "button-req-content": true });
      const html = "<button>       </button>";
  ...
  it(
    "Should report an error when button has no text (deep nesting)",
    async () => {
      const linter = createLinter({ "button-req-content": true });
  ...
  it(
    "Should not report an error when button has text and an html comment",
    async () => {
      const linter = createLinter({ "button-req-content": true });
  ...
  it(
    "Should not report an error when button has text content (deep nesting)",
    async () => {
      const linter = createLinter({ "button-req-content": true });
  ...
  it(
    "Should not report an error when button has text content (multiple text deep nesting)",
    async () => {
      const linter = createLinter({ "button-req-content": true });
  ...
  it(
    "Should report an error when button has an aria-label with no content",
    async () => {
      const linter = createLinter({ "button-req-content": true });
  ...
  it(
    "Should not report an error when button has an aria-label with content",
    async () => {
      const linter = createLinter({ "button-req-content": true });
