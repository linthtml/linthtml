...
The migration from htmllint to LintHTML is easy, as all htmllint's rules can be used with LintHTML – just follow this [simple guide](https://linthtml.vercel.app/#migrate-from-htmllint).
...
If you want to read about alternative installation and usage methods, have a look to the [installation and usage](https://linthtml.vercel.app/#installation-and-usage) page in the documentation.
