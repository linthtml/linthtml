...
describe("legacy linter | link-rel-noopener", function () {
  ...
  it('Should not report an error when "target" equal "_blank" and "rel" attribute equal "noopener"', async function () {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should not report an error when "target" equal "_blank" and "rel" attribute equal "noreferrer"', async function () {
    const linter = createLinter({ "link-req-noopener": true });
  ...
  it('Should not report an error when "target" equal "_blank" and "rel" attribute equal "noreferrer" and "noopener"', async function () {
    const linter = createLinter({ "link-req-noopener": true });
