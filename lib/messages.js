...
var errors = {
  ...
  E033: "input with id: <%= idValue %> is not associated with a label for accessibility",
  E034: "Radio input must have an associated name",
  E035: "Table must have a header for accessibility",
  E036: "Wrong indentation, expected indentation of <%= expected %> go <%= width %>",
  ...
  E057: `Mandatory attribute "<%= attribute =%>" is missing in tag "<%= tag =%>"`,
