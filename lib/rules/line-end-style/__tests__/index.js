...
describe("line-end-style", function() {
  describe(`"cr" mode`, function() {
    ...
    it("Should report errors for invalide end line", function(done) {
    ...
    it("Should not report any error for valide end line", function(done) {
      const linter = createLinter();
      const html = [
        "<body>\n",
        "  <p>\r",
  ...
  describe(`"lf" mode`, function() {
    ...
    it("Should report errors for invalide end line", function(done) {
      ...
      linter.lint(html, none, { "line-end-style": "lf" }).then((issues) => {
        expect(issues).to.have.lengthOf(0);
        done();
      }); 
    });
