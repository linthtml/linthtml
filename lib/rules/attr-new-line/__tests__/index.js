...
describe("attr-name-style", function() {
  ...
  it("Should report and error when there's more than one attribute on the first line and configuration is '+0'", function(done) {
    const linter = createLinter();
  ...
  it("Should report and error when there's attributes on line > 1 and configuration is '+0'", function(done) {
    const linter = createLinter();
    const html = `
      <div
        class="foo"
