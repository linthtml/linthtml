module.exports = [
  {
    ...
    input:
      '<body><div><p class="hey" id="fat" class="mdo">Text</p></div></body>',
  ...
  },
  {
    ...
    input:
      '<body><div><p class="hey" id="fat" class="mdo" id="Whaddup">Text</p></div></body>',
    opts: { "attr-no-dup": true },
    output: 2
  },
  {
    ...
    input:
      '<body><div class="mdo" class="hey"><p id="Whaddup" id="fat">Text</p></div></body>',
    opts: { "attr-no-dup": true },
    output: 2
  },
  {
