module.exports = [
  ...
  {
    desc:
      "should not give additional errors for attributes which are not present",
    input: '<img src="test.gif" class="test"></img>',
    opts: { "attr-order": ["class", "src", "height", "width"] },
    output: 1
  },
  ...
  {
    desc:
      "should pass when attribute order is consistent with regex (class then everything else)",
    input: '<img class="test" src="test.gif" height="200" width="300"></img>',
    opts: { "attr-order": ["class", "/^.*$/"] },
    output: 0
  },
  {
    desc:
      "should fail when attribute order is not consistent with regex (class then everything else)",
  ...
  {
    desc:
      "should give one error per misplaced attribute with regex (class then everything else)",
  ...
  {
    desc:
      "should pass when attribute order is consistent with regex (class then data tags)",
  ...
  {
    desc:
      "should fail when attribute order is not consistent with regex (class then data tags)",
  ...
  {
    desc:
      "should pass when attribute order is consistent with regex (class then data tags then others)",
  ...
  {
    desc:
      "should fail when attribute order is not consistent with regex (class then data tags then others)",
    input: '<img class="test" src="test.gif" data-x="123" data-y="456"></img>',
    opts: { "attr-order": ["class", "/^data-.*$/", "/^.*$/"] },
    output: 1
  }
