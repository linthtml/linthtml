module.exports = [
  ...
  },
  {
    ...
    input:
      "<section><!DOCTYPE html><div><p>Hello</p><p>World</p></div></section>",
    opts: { "doctype-first": true },
    output: 1
  },
  {
    desc:
      "should pass when multiple !DOCTYPEs are present, as long as a !DOCTYPE is first",
    input:
      "<!DOCTYPE><section><!DOCTYPE><div><p>Hello</p><p>World</p></div></section>",
    opts: { "doctype-first": true },
    output: 0
  },
  {
  ...
  },
  {
    ...
    input:
      "<head></head><section><div><p>Hello</p><p>World</p></div></section>",
    opts: { "doctype-first": "smart" },
    output: 1
  },
  {
