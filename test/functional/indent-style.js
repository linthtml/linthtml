module.exports = [
  ...
  },
  {
    ...
    input: ["<body>", "\t <p>this not okay</p>", "</body>"].join("\n"),
    opts: { "indent-style": "spaces" },
    output: 1
  },
  {
  ...
  {
    desc:
      "indent-width-cont should match indents with the wrong number of spaces starting with <",
    input: [
      "<body>",
      "        <p>eight spaces</p>",
      "          <p>ten spaces</p>",
  ...
  // { // FIX: Should not allow space indent if set to tab!!
