module.exports = [
  ...
  },
  {
    ...
    input:
      '<body><div><p class="hi {foo bar} {foo x bar} hello ">Text</p></div></body>',
    opts: { "class-no-dup": true, "id-class-ignore-regex": "{.*?}" },
    output: 0
  },
  {
    ...
    input:
      '<body><div><p class="hey {foo bar} hey hi {foo bar}">Text</p></div></body>',
    opts: { "class-no-dup": true, "id-class-ignore-regex": "{.*?}" },
    output: 2
  },
  {
    ...
    input:
      '<body><div><p class="  hey {foo bar} hi {foo baz}">Text</p></div></body>',
    opts: { "class-no-dup": true, "id-class-ignore-regex": "(({)(.*?)})" },
    output: 0
  },
  {
    ...
    input:
      '<body><div><p class="hi {(foo bar)} {(foo baz)} hey">Text</p></div></body>',
    opts: { "class-no-dup": true, "id-class-ignore-regex": "{(.*?)}" },
    output: 0
  }
];
