module.exports = [
  ...
  {
    desc:
      "should return an error if the text input has no label parent and no id/name",
  ...
  {
    desc:
      "should return an error if the radio input has no label parent and no id/name",
  ...
  },
  {
    ...
    input:
      '<div><label><p><div><input type="text" value="great" ></div></p></label></div>',
    opts: { "input-req-label": true },
    output: 0
  },
  {
    ...
    input:
      '<div><label><p><div><input type="radio" value="great" ></div></p></label></div>',
    opts: { "input-req-label": true },
    output: 0
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="text" name="romeo"></section> ',
    opts: { "input-req-label": true },
    output: 1
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="text" name="dinosaur"></section> ',
    opts: { "input-req-label": true },
    output: 0
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="text" id="romeo"></section> ',
    opts: { "input-req-label": true },
    output: 1
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="text" id="dinosaur"></section> ',
    opts: { "input-req-label": true },
    output: 0
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="radio" name="dinosaur"></section> ',
    opts: { "input-req-label": true },
    output: 1
  },
  {
    ...
    input:
      '<div><label for="dinosaur">Label!</label></div><section><input type="radio" id="dinosaur"></section> ',
    opts: { "input-req-label": true },
    output: 0
  }
];
